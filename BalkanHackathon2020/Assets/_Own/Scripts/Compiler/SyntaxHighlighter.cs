...
public static class SyntaxHighlighter
{
    ...
    static string HighlightLine (string line, SyntaxTheme theme) {
        ...
        for (int i = 0; i < sections.Length; i++) {
            ...
            if (section == Compiler.commentMarker || isComment) {
            ...
            } else if (Compiler.ArrayContainsString (Compiler.mathOperators, section)) {
                colour = theme.mathOperator;
            } else if (Compiler.ArrayContainsString (Compiler.comparisonOperators, section)) {
