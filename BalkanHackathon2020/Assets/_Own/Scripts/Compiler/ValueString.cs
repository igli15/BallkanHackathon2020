...
public class ValueString {
    ...
    public ValueString (string code, Dictionary<string, float> variables) {
        ...
        for (int i = 0; i < sections.Length; i++) {
            ...
            if (Compiler.ArrayContainsString (Compiler.builtinFunctions, section)) {
                switch (section) {
                    case "sqrt":
            ...
            else if (Compiler.ArrayContainsString (Compiler.mathOperators, section) || section == "(" || section == ")") {
                switch (section) {
                    case "+":
            ...
            // Try get value from variable array
                ...
                string indexString = Compiler.Substring (section, section.IndexOf ("[") + 1, section.IndexOf ("]"));
                ...
                string varName = section.Substring (0, section.IndexOf ("[")) + Compiler.arrayIndexSeperator + index;
